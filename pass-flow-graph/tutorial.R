...
pass_heatmap <- function(player) {
    ...
    p <- ggplot(data = PassFlow) +
        ...
        geom_bin2d(data = PlayerPF_lite, aes(x = location.x, y = location.y), alpha = .6,
